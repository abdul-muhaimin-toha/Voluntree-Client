...
const Footer = () => {
  return (
    <section className="dark:text-dark bg-black text-white dark:bg-white">
      <div className="mx-auto max-w-screen-2xl px-4">
        <footer className="footer footer-center gap-4 px-4 py-10 ">
          <div className="flex max-w-xs items-center justify-center">
            <h2 className="font-logo text-5xl text-primary md:text-6xl">
              voluntree
            </h2>
          </div>
          <aside className="text-xs md:text-sm">
            <p className="mt-3 font-bold tracking-wider">
              Rong Mohol Industries Ltd.
            </p>
            ...
            <div className="grid grid-flow-col gap-4">
              <Link to="https://twitter.com" target="blank">
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  className="fill-current transition-all duration-150 hover:text-primary"
                >
