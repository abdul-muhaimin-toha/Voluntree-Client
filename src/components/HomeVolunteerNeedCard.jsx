...
const HomeVolunteerNeedCard = () => {
  return (
    <div className="flex rounded-lg border-2 border-primary shadow-lg">
      <div className="flex grow flex-col gap-6 rounded-md bg-black  p-4 md:gap-10">
        <img
          src={thumbnail}
          alt="Product image"
        ...
        <div className="flex flex-col items-start justify-center gap-3">
          ...
          <div className="flex w-full flex-wrap items-center justify-between gap-3">
            <h4 className="gap-1 rounded-full bg-white px-4 py-1 text-xs font-bold capitalize text-black">
              healthcare
            </h4>
